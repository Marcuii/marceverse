/**
 * @file NotFound.jsx
 * @description 404 catch-all page for unmatched client-side routes.
 *
 * Displays an animated message and a "Go Home" link.
 */

// eslint-disable-next-line no-unused-vars -- used as <motion.div>, <motion.h1>
