 ...
 * @description Horizontal timeline of work / professional experience entries.
 *
 * Cards animate in from the left using `framer-motion` and link to the
 * full-detail ExperiencePage.
 */
