/**
 * @file StickyNavbar.jsx
 * @description Responsive top navigation bar for the public portfolio.
 *
 * Features:
 *  - Section-aware active highlighting via IntersectionObserver
 *  - Smooth-scroll navigation (even cross-page from detail routes)
 *  - 30+ DaisyUI theme switcher dropdown
 *  - Mobile-friendly collapsible menu
 *  - Scroll-triggered padding & shadow animation
 */
...
/** @type {{ icon: React.ComponentType, title: string, href: string }[]} Navigation links mapping to Home page sections. */
const LINKS = [
  {
    icon: FaHome,
    title: "Home",
...
/** Available DaisyUI theme identifiers. */
const themes = [
  "light",
  "dark",
  "cupcake",
...
/** Persist the selected theme to both the DOM and localStorage. */
        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row w-fit">
            ...
            <span className="hidden pt-1 h-12 pl-6 border-l-2 text-3xl border-primary xl:block">
              {generalInfo ? "MarceVerse" : "MarceVerse"}
            </span>
          </div>
