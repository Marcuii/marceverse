/**
 * @file Landing.jsx
 * @description Full-screen animated intro shown on initial page load.
 *
 * Features nested orbiting technology icons (4 concentric rings),
 * a typewriter "Welcome!" heading, a particle canvas background,
 * and a bounce-down scroll indicator.  The overlay slides up out
 * of view once the user scrolls past 15 px.
 */
...
/**
 * Single concentric orbit ring with positioned icon children.
 *
 * @param {{ size: string, duration: string, icons: Array, reverse?: boolean, children?: React.ReactNode }} props
 */
