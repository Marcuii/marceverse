/**
 * @file ParticlesComponent.jsx
 * @description Interactive particle canvas used on the Landing page.
 *
 * Reads the current DaisyUI theme's `--p` (primary) and `--nc`
 * (neutral-content) CSS variables, converts them from OKLCh to HEX
 * via `culori`, and feeds the colours to `@tsparticles`.  A
 * MutationObserver keeps the particles in sync when the user
