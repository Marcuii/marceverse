/**
 * @file ParticlesComponent2.jsx
 * @description Background particle canvas for the main content area.
 *
 * Identical configuration to `ParticlesComponent` but with swapped
 * primary / neutral colours so the two canvases are visually
 * complementary (Landing = primary particles, Content = neutral particles).
 */
